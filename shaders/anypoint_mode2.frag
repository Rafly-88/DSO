...
// Prevents streaky/blocky pixelation on mobile
...
// 4. Controls (Mapped from your Dart code's _alpha and _beta)
uniform float thetaX_degree;              // 16 
uniform float thetaY_degree;              // 17
...
// Updated to match your Python script (axis_m3048p)
...
void main() {
    ...
    // Negations explicitly translated from the Python logic
    tempX = -tempX;
    tempY = -tempY;
    ...
    // Mobile Optimization: Cascade multiplication instead of pow()
